...
# find_packages will search for folder and convert it into package. In our case our folder is 'activities'.
...
setup(
    ...
    version="1.0.0",
    description="This is a fake news detection project using NLP",
